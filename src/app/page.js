    ...
    <main>
      ...
      <section className="bg-gray-100 p-10 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="p-4">
            ...
            <p className="font-semibold">Completás el pago</p>
            <p className="text-gray-600 text-sm">Confirmación instantánea</p>
          </div>
        </div>
      </section>
      ...
      <section className="p-10 text-center bg-white">
        ...
        <button
          ...
          className="bg-green-600 text-white px-8 py-3 rounded-2xl hover:bg-green-700 text-lg"
        >
          Reservar Ahora
        </button>
      </section>
