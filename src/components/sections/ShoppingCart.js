  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-40 rounded-[1.5rem] border border-black/10 bg-white p-4 shadow-2xl sm:left-auto sm:right-6 sm:max-w-sm">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="font-black text-[#11130f]">Booking request ({cart.length})</h3>
        <p className="rounded-full bg-amber-100 px-3 py-1 text-xs font-black text-amber-800">Draft</p>
      </div>
